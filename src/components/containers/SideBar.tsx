...
const SideBar: React.FC<SideBarProps> = ({ locale, middleTexts }) => {
  ...
  return (
    <aside
      className={`fixed top-0 z-40 w-full h-full flex flex-row flex-nowrap border-r border-dark-white ${isSideActive ? 'translate-x-0' : '-translate-x-full'} md:w-2/4 lg:w-full lg:col-start-1 lg:col-end-4 lg:row-start-1 lg:row-end-6 transition-transform lg:static lg:translate-x-0 duration-500 ease-in-out`}
    >
